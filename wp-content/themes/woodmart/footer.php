					...
					<div class="container">
						<div class="min-footer">
							<div class="col-left set-cont-mb-s reset-last-child">
								...
								<?php else : ?>
									<p> <a href="https://modiru.com/product/%d9%82%d8%a7%d9%84%d8%a8-%d9%88%d9%88%d8%af%d9%85%d8%a7%d8%b1%d8%aa/">قالب وودمارت </a>- <?php esc_html_e( 'تمامی حقوق برای این سایت محفوظ است.', 'مدیریو' ) ?></p>
								<?php endif ?>
							</div>
